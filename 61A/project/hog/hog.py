...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score+=hog_pile(score0+score,score1)
            score0+=score
        else:
            score=take_turn(strategy1(score1,score0),score0, dice, goal)
            score+=hog_pile(score1+score,score0)
            score1+=score
        who=(who+1)%2
    # END PROBLEM 5
    ...
    def say(score0, score1):
        ...
        if score > last_score:
            ...
            if running > running_high:
                running_h = running
                print(running_h, "point(s)! That's a record gain for Player", str(who)+'!')
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if hog_pile(score + picky_piggy(opponent_score), opponent_score) \
        else picky_piggy_strategy(score, opponent_score, cutoff, num_rolls)
    # END PROBLEM 11
